...
usersRouter.get('/', function (req, res) { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, userServices_1["default"].login(req.query.phone)];
            case 1:
                user = _a.sent();
                res.json(user);
                return [2 /*return*/];
...
usersRouter.post('/', function (req, res) { return __awaiter(_this, void 0, void 0, function () {
    var user;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, userServices_1["default"].signup(req.body)];
            case 1:
                user = _a.sent();
                res.json(user);
                return [2 /*return*/];
